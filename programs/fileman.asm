; ------------------------------------------------------------------
; Simple file manager for CompOS: copy, delete and rename files
; ------------------------------------------------------------------
	...
	; This is the point used by the disk buffer in the CompOS kernel
...
.draw_background:
	...
	.title_msg		db 'CompOS File Manager', 0
