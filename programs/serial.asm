; ------------------------------------------------------------------
; Minicom-like program for CompOS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your CompOS machine and Linux machine.
; Start CompOS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the CompOS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'CompOS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting CompOS minicom; press a key to return to CompOS', 13, 10, 0
